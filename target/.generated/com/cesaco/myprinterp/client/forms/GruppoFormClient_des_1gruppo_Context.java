...
public class GruppoFormClient_des_1gruppo_Context extends com.google.gwt.editor.client.impl.AbstractEditorContext<java.lang.String> {
  private final com.cesaco.myprinterp.client.shared.Gruppo parent;
  public GruppoFormClient_des_1gruppo_Context(com.cesaco.myprinterp.client.shared.Gruppo parent, com.google.gwt.editor.client.Editor<java.lang.String> editor, String path) {
    super(editor,path);
    this.parent = parent;
  }
  ...
  @Override public java.lang.String getFromModel() {
    return (parent != null && true) ? parent.getDes_gruppo() : null;
  }
  @Override public void setInModel(java.lang.String data) {
    parent.setDes_gruppo(data);
  }
}
