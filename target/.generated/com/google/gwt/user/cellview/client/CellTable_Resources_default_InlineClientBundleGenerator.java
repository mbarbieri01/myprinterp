  ...
  private void cellTableStyleInitializer() {
    cellTableStyle = new com.google.gwt.user.cellview.client.CellTable.Style() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GP34Q33ED{border-top:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("right")  + ";color:" + ("#4b4a4a")  + ";text-shadow:" + ("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GP34Q33FD{border-bottom:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("right")  + ";color:" + ("#4b4a4a")  + ";text-shadow:") + (("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GP34Q33OC{padding:" + ("2px"+ " " +"15px")  + ";overflow:" + ("hidden")  + ";}.GP34Q33DE{cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GP34Q33DE:hover{color:" + ("#6c6b6b")  + ";}.GP34Q33PC{background:" + ("#fff")  + ";}.GP34Q33AD{border:" + ("2px"+ " " +"solid"+ " " +"#fff")  + ";}.GP34Q33PD{background:" + ("#f3f7fb")  + ";}.GP34Q33AE{border:" + ("2px"+ " " +"solid"+ " " +"#f3f7fb") ) + (";}.GP34Q33GD{background:" + ("#eee")  + ";}.GP34Q33HD{border:" + ("2px"+ " " +"solid"+ " " +"#eee")  + ";}.GP34Q33JD{background:" + ("#ffc")  + ";}.GP34Q33KD{border:" + ("2px"+ " " +"solid"+ " " +"#ffc")  + ";}.GP34Q33BE{background:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("auto")  + ";}.GP34Q33CE{border:" + ("2px"+ " " +"solid"+ " " +"#628cd5")  + ";}.GP34Q33ID{border:" + ("2px"+ " " +"solid"+ " " +"#d7dde8")  + ";}.GP34Q33OD{margin:") + (("30px")  + ";}")) : ((".GP34Q33ED{border-top:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("left")  + ";color:" + ("#4b4a4a")  + ";text-shadow:" + ("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GP34Q33FD{border-bottom:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("left")  + ";color:" + ("#4b4a4a")  + ";text-shadow:") + (("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GP34Q33OC{padding:" + ("2px"+ " " +"15px")  + ";overflow:" + ("hidden")  + ";}.GP34Q33DE{cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GP34Q33DE:hover{color:" + ("#6c6b6b")  + ";}.GP34Q33PC{background:" + ("#fff")  + ";}.GP34Q33AD{border:" + ("2px"+ " " +"solid"+ " " +"#fff")  + ";}.GP34Q33PD{background:" + ("#f3f7fb")  + ";}.GP34Q33AE{border:" + ("2px"+ " " +"solid"+ " " +"#f3f7fb") ) + (";}.GP34Q33GD{background:" + ("#eee")  + ";}.GP34Q33HD{border:" + ("2px"+ " " +"solid"+ " " +"#eee")  + ";}.GP34Q33JD{background:" + ("#ffc")  + ";}.GP34Q33KD{border:" + ("2px"+ " " +"solid"+ " " +"#ffc")  + ";}.GP34Q33BE{background:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("auto")  + ";}.GP34Q33CE{border:" + ("2px"+ " " +"solid"+ " " +"#628cd5")  + ";}.GP34Q33ID{border:" + ("2px"+ " " +"solid"+ " " +"#d7dde8")  + ";}.GP34Q33OD{margin:") + (("30px")  + ";}"));
      }
