  ...
  private void stylesInitializer() {
    styles = new com.sencha.gxt.core.client.resources.CommonStyles.CommonStylesDefaultAppearance.CommonDefaultStyles() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GP34Q33FK,.GP34Q33FK:focus{outline:" + ("none")  + ";}.GP34Q33IK{position:" + ("absolute")  + " !important;right:" + ("0")  + ";top:" + ("0")  + ";}.GP34Q33AK{display:" + ("none")  + " !important;}.GP34Q33BK{position:" + ("absolute")  + " !important;right:" + ("-10000px")  + " !important;top:" + ("-10000px")  + " !important;visibility:" + ("hidden")  + " !important;}.GP34Q33CK{visibility:" + ("hidden")  + " !important;}.GP34Q33LK,.GP34Q33LK *{-moz-user-select:") + (("none")  + ";-khtml-user-select:" + ("none")  + ";-webkit-user-select:" + ("ignore")  + ";}.GP34Q33MK{-moz-user-select:" + ("-moz-none")  + ";-khtml-user-select:" + ("none")  + ";-webkit-user-select:" + ("ignore")  + ";}.x-clear{clear:" + ("both")  + ";overflow:" + ("hidden")  + ";line-height:" + ("0")  + ";font-size:" + ("0")  + ";}.GP34Q33PJ{float:" + ("left") ) + (";}.GP34Q33MJ{cursor:" + ("w-resize")  + ";cursor:" + ("col-resize")  + ";}.GP34Q33NJ{cursor:" + ("n-resize")  + ";cursor:" + ("row-resize")  + ";}.GP34Q33EK{position:" + ("relative")  + ";display:" + ("inline-block")  + ";}.GP34Q33HK{white-space:" + ("nowrap")  + ";}.GP34Q33KK{height:" + ((CommonStyles_CommonStylesDefaultAppearance_CommonDefaultResources_safari_default_InlineClientBundleGenerator.this.shim()).getHeight() + "px")  + ";width:" + ((CommonStyles_CommonStylesDefaultAppearance_CommonDefaultResources_safari_default_InlineClientBundleGenerator.this.shim()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:") + (("url(\"" + (CommonStyles_CommonStylesDefaultAppearance_CommonDefaultResources_safari_default_InlineClientBundleGenerator.this.shim()).getSafeUri().asString() + "\") -" + (CommonStyles_CommonStylesDefaultAppearance_CommonDefaultResources_safari_default_InlineClientBundleGenerator.this.shim()).getLeft() + "px -" + (CommonStyles_CommonStylesDefaultAppearance_CommonDefaultResources_safari_default_InlineClientBundleGenerator.this.shim()).getTop() + "px  no-repeat")  + ";width:" + ("100%")  + ";height:" + ("100%")  + ";display:" + ("none")  + ";position:" + ("absolute")  + ";right:" + ("0")  + ";top:" + ("0")  + ";z-index:" + ("20000")  + ";}.GP34Q33OJ *{color:" + ("gray")  + " !important;cursor:" + ("default")  + " !important;}.GP34Q33OJ{cursor:" + ("default") ) + (" !important;opacity:" + ("0.6")  + ";}")) : ((".GP34Q33FK,.GP34Q33FK:focus{outline:" + ("none")  + ";}.GP34Q33IK{position:" + ("absolute")  + " !important;left:" + ("0")  + ";top:" + ("0")  + ";}.GP34Q33AK{display:" + ("none")  + " !important;}.GP34Q33BK{position:" + ("absolute")  + " !important;left:" + ("-10000px")  + " !important;top:" + ("-10000px")  + " !important;visibility:" + ("hidden")  + " !important;}.GP34Q33CK{visibility:" + ("hidden")  + " !important;}.GP34Q33LK,.GP34Q33LK *{-moz-user-select:") + (("none")  + ";-khtml-user-select:" + ("none")  + ";-webkit-user-select:" + ("ignore")  + ";}.GP34Q33MK{-moz-user-select:" + ("-moz-none")  + ";-khtml-user-select:" + ("none")  + ";-webkit-user-select:" + ("ignore")  + ";}.x-clear{clear:" + ("both")  + ";overflow:" + ("hidden")  + ";line-height:" + ("0")  + ";font-size:" + ("0")  + ";}.GP34Q33PJ{float:" + ("right") ) + (";}.GP34Q33MJ{cursor:" + ("e-resize")  + ";cursor:" + ("col-resize")  + ";}.GP34Q33NJ{cursor:" + ("n-resize")  + ";cursor:" + ("row-resize")  + ";}.GP34Q33EK{position:" + ("relative")  + ";display:" + ("inline-block")  + ";}.GP34Q33HK{white-space:" + ("nowrap")  + ";}.GP34Q33KK{height:" + ((CommonStyles_CommonStylesDefaultAppearance_CommonDefaultResources_safari_default_InlineClientBundleGenerator.this.shim()).getHeight() + "px")  + ";width:" + ((CommonStyles_CommonStylesDefaultAppearance_CommonDefaultResources_safari_default_InlineClientBundleGenerator.this.shim()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:") + (("url(\"" + (CommonStyles_CommonStylesDefaultAppearance_CommonDefaultResources_safari_default_InlineClientBundleGenerator.this.shim()).getSafeUri().asString() + "\") -" + (CommonStyles_CommonStylesDefaultAppearance_CommonDefaultResources_safari_default_InlineClientBundleGenerator.this.shim()).getLeft() + "px -" + (CommonStyles_CommonStylesDefaultAppearance_CommonDefaultResources_safari_default_InlineClientBundleGenerator.this.shim()).getTop() + "px  no-repeat")  + ";width:" + ("100%")  + ";height:" + ("100%")  + ";display:" + ("none")  + ";position:" + ("absolute")  + ";left:" + ("0")  + ";top:" + ("0")  + ";z-index:" + ("20000")  + ";}.GP34Q33OJ *{color:" + ("gray")  + " !important;cursor:" + ("default")  + " !important;}.GP34Q33OJ{cursor:" + ("default") ) + (" !important;opacity:" + ("0.6")  + ";}"));
      }
