...
public class ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator implements com.sencha.gxt.theme.base.client.field.ErrorTipDefaultAppearance.ErrorTipResources {
  ...
  private void styleInitializer() {
    style = new com.sencha.gxt.theme.base.client.field.ErrorTipDefaultAppearance.ErrorTipStyle() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GP34Q33DT{padding:" + ("2px")  + ";font-size:" + ("12px")  + ";}.GP34Q33ET{float:" + ("left")  + ";}.GP34Q33AT{color:" + ("#444")  + ";font:" + ("bold"+ " " +"11px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"helvetica"+ ","+ " " +"sans-serif")  + ";}.GP34Q33BT{color:" + ("#444")  + ";font:" + ("11px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"helvetica"+ ","+ " " +"sans-serif")  + ";}.GP34Q33NS{height:" + ((ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.anchorBottom()).getHeight() + "px")  + ";width:" + ((ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.anchorBottom()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:") + (("url(\"" + (ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.anchorBottom()).getSafeUri().asString() + "\") -" + (ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.anchorBottom()).getLeft() + "px -" + (ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.anchorBottom()).getTop() + "px  no-repeat")  + ";position:" + ("absolute")  + ";}.GP34Q33PS{height:" + ((ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.anchorRight()).getHeight() + "px")  + ";width:" + ((ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.anchorRight()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.anchorRight()).getSafeUri().asString() + "\") -" + (ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.anchorRight()).getLeft() + "px -" + (ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.anchorRight()).getTop() + "px  no-repeat")  + ";position:" + ("absolute")  + ";}.GP34Q33OS{height:" + ((ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.anchorLeft()).getHeight() + "px")  + ";width:" + ((ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.anchorLeft()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.anchorLeft()).getSafeUri().asString() + "\") -" + (ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.anchorLeft()).getLeft() + "px -" + (ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.anchorLeft()).getTop() + "px  no-repeat") ) + (";position:" + ("absolute")  + ";}.GP34Q33AT{font:" + ("bold"+ " " +"11px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"helvetica"+ ","+ " " +"sans-serif")  + ";color:" + ("#444")  + ";}.GP34Q33BT{font:" + ("11px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"helvetica"+ ","+ " " +"sans-serif")  + ";color:" + ("#444")  + ";padding-right:" + ("0")  + ";}.GP34Q33CT{height:" + ((ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.errorIcon()).getHeight() + "px")  + ";width:" + ((ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.errorIcon()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.errorIcon()).getSafeUri().asString() + "\") -" + (ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.errorIcon()).getLeft() + "px -" + (ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.errorIcon()).getTop() + "px  no-repeat")  + ";width:") + (("auto")  + ";height:" + ("auto")  + ";background-position:" + ("-1"+ " " +"4px")  + ";padding-right:" + ("20px")  + ";}")) : ((".GP34Q33DT{padding:" + ("2px")  + ";font-size:" + ("12px")  + ";}.GP34Q33ET{float:" + ("right")  + ";}.GP34Q33AT{color:" + ("#444")  + ";font:" + ("bold"+ " " +"11px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"helvetica"+ ","+ " " +"sans-serif")  + ";}.GP34Q33BT{color:" + ("#444")  + ";font:" + ("11px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"helvetica"+ ","+ " " +"sans-serif")  + ";}.GP34Q33NS{height:" + ((ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.anchorBottom()).getHeight() + "px")  + ";width:" + ((ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.anchorBottom()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:") + (("url(\"" + (ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.anchorBottom()).getSafeUri().asString() + "\") -" + (ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.anchorBottom()).getLeft() + "px -" + (ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.anchorBottom()).getTop() + "px  no-repeat")  + ";position:" + ("absolute")  + ";}.GP34Q33PS{height:" + ((ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.anchorRight()).getHeight() + "px")  + ";width:" + ((ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.anchorRight()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.anchorRight()).getSafeUri().asString() + "\") -" + (ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.anchorRight()).getLeft() + "px -" + (ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.anchorRight()).getTop() + "px  no-repeat")  + ";position:" + ("absolute")  + ";}.GP34Q33OS{height:" + ((ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.anchorLeft()).getHeight() + "px")  + ";width:" + ((ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.anchorLeft()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.anchorLeft()).getSafeUri().asString() + "\") -" + (ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.anchorLeft()).getLeft() + "px -" + (ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.anchorLeft()).getTop() + "px  no-repeat") ) + (";position:" + ("absolute")  + ";}.GP34Q33AT{font:" + ("bold"+ " " +"11px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"helvetica"+ ","+ " " +"sans-serif")  + ";color:" + ("#444")  + ";}.GP34Q33BT{font:" + ("11px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"helvetica"+ ","+ " " +"sans-serif")  + ";color:" + ("#444")  + ";padding-left:" + ("0")  + ";}.GP34Q33CT{height:" + ((ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.errorIcon()).getHeight() + "px")  + ";width:" + ((ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.errorIcon()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.errorIcon()).getSafeUri().asString() + "\") -" + (ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.errorIcon()).getLeft() + "px -" + (ErrorTipDefaultAppearance_ErrorTipResources_safari_default_InlineClientBundleGenerator.this.errorIcon()).getTop() + "px  no-repeat")  + ";width:") + (("auto")  + ";height:" + ("auto")  + ";background-position:" + ("-1"+ " " +"4px")  + ";padding-left:" + ("20px")  + ";}"));
      }
  ...
  private static final java.lang.String externalImage3 = GWT.getModuleBaseURL() + "D4A6540E96842E03327A041C241D2B63.cache.png";
