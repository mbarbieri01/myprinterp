...
public class GrayTreeAppearance_GrayTreeResources_default_InlineClientBundleGenerator implements com.sencha.gxt.theme.gray.client.tree.GrayTreeAppearance.GrayTreeResources {
  private static GrayTreeAppearance_GrayTreeResources_default_InlineClientBundleGenerator _instance0 = new GrayTreeAppearance_GrayTreeResources_default_InlineClientBundleGenerator();
  ...
  private void styleInitializer() {
    style = new com.sencha.gxt.theme.base.client.tree.TreeBaseAppearance.TreeBaseStyle() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GP34Q33IOB{cursor:" + ("default")  + ";-moz-outline:" + ("none")  + ";-moz-user-focus:" + ("none")  + ";outline:" + ("0"+ " " +"none")  + ";position:" + ("relative")  + ";padding-bottom:" + ("1px")  + ";}.GP34Q33EOB{cursor:" + ("default")  + ";}.GP34Q33BOB{white-space:" + ("nowrap")  + ";height:" + ("21px")  + ";}.GP34Q33ONB{display:" + ("none")  + ";}.GP34Q33HOB{white-space:") + (("nowrap")  + ";line-height:" + ("11px")  + ";text-decoration:" + ("none")  + ";padding:" + ("0"+ " " +"3px"+ " " +"0"+ " " +"0")  + ";display:" + ("inline-block")  + ";vertical-align:" + ("top")  + ";margin-top:" + ("3px")  + ";font:" + ("normal"+ " " +"11px"+ " " +"arial"+ ","+ " " +"tahoma"+ ","+ " " +"helvetica"+ ","+ " " +"sans-serif")  + ";color:" + ("black")  + ";}.GP34Q33PNB{background-image:" + ("none")  + " !important;background-color:" + ("#defadc") ) + (" !important;}.GP34Q33FOB,.GP34Q33AOB{background-color:" + ("#eee")  + ";}.GP34Q33GOB{background-color:" + ("#e5e5e5")  + " !important;}")) : ((".GP34Q33IOB{cursor:" + ("default")  + ";-moz-outline:" + ("none")  + ";-moz-user-focus:" + ("none")  + ";outline:" + ("0"+ " " +"none")  + ";position:" + ("relative")  + ";padding-bottom:" + ("1px")  + ";}.GP34Q33EOB{cursor:" + ("default")  + ";}.GP34Q33BOB{white-space:" + ("nowrap")  + ";height:" + ("21px")  + ";}.GP34Q33ONB{display:" + ("none")  + ";}.GP34Q33HOB{white-space:") + (("nowrap")  + ";line-height:" + ("11px")  + ";text-decoration:" + ("none")  + ";padding:" + ("0"+ " " +"0"+ " " +"0"+ " " +"3px")  + ";display:" + ("inline-block")  + ";vertical-align:" + ("top")  + ";margin-top:" + ("3px")  + ";font:" + ("normal"+ " " +"11px"+ " " +"arial"+ ","+ " " +"tahoma"+ ","+ " " +"helvetica"+ ","+ " " +"sans-serif")  + ";color:" + ("black")  + ";}.GP34Q33PNB{background-image:" + ("none")  + " !important;background-color:" + ("#defadc") ) + (" !important;}.GP34Q33FOB,.GP34Q33AOB{background-color:" + ("#eee")  + ";}.GP34Q33GOB{background-color:" + ("#e5e5e5")  + " !important;}"));
      }
  ...
  private native ResourcePrototype getResourceNative(String name) /*-{
    switch (name) {
      ...
      case 'style': return this.@com.sencha.gxt.theme.gray.client.tree.GrayTreeAppearance.GrayTreeResources::style()();
    }
    return null;
  }-*/;
}
