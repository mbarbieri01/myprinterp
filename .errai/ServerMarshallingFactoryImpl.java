...
public class ServerMarshallingFactoryImpl implements MarshallerFactory {
  ...
  private Marshaller<Member> com_cesaco_myprinterp_client_shared_Member;
  ...
  private Marshaller<Macchina> com_cesaco_myprinterp_client_shared_Macchina;
  ...
  private Marshaller<Gruppo> com_cesaco_myprinterp_client_shared_Gruppo;
  ...
  public ServerMarshallingFactoryImpl() {
    ...
    com_cesaco_myprinterp_client_shared_Member = new Marshaller<Member>() {
      public Class getTypeHandled() {
        return Member.class;
      }
      public Member demarshall(EJValue a0, MarshallingSession a1) {
        try {
          ...
          t.printStackTrace();
          throw new RuntimeException("error demarshalling entity: com.cesaco.myprinterp.client.shared.Member", t);
        }
      }
      public String marshall(Member a0, MarshallingSession a1) {
        ...
        if (a1.hasObjectHash(a0)) {
          String objId = a1.getObjectHash(a0);
          return new StringBuilder(128).append("{\"^EncodedType\":\"com.cesaco.myprinterp.client.shared.Member\"").append(",").append("\"^ObjectID\":\"").append(objId).append("\"}").toString();
        }
        String objId = a1.getObjectHash(a0);
        a1.recordObjectHash(objId, objId);
        return new StringBuilder(640).append("{\"^EncodedType\":\"com.cesaco.myprinterp.client.shared.Member\",\"^ObjectID\":\"").append(objId).append("\"").append(",").append("\"id\" : ").append(java_lang_Long.marshall(a0.getId(), a1)).append(",").append("\"name\" : ").append(java_lang_String.marshall(a0.getName(), a1)).append(",").append("\"email\" : ").append(java_lang_String.marshall(a0.getEmail(), a1)).append(",").append("\"phoneNumber\" : ").append(java_lang_String.marshall(a0.getPhoneNumber(), a1)).append("}").toString();
      }
    };
    marshallers.put("com.cesaco.myprinterp.client.shared.Member", com_cesaco_myprinterp_client_shared_Member);
    ...
    com_cesaco_myprinterp_client_shared_Macchina = new Marshaller<Macchina>() {
      public Class getTypeHandled() {
        return Macchina.class;
      }
      public Macchina demarshall(EJValue a0, MarshallingSession a1) {
        try {
          if (a0.isNull()) {
            return null;
          }
          ...
          String objId = obj.get("^ObjectID").isString().stringValue();
          if (a1.hasObjectHash(objId)) {
            return a1.getObject(Macchina.class, objId);
          }
          Macchina entity = new Macchina();
          a1.recordObjectHash(objId, entity);
          if ((obj.containsKey("id")) && (!obj.get("id").isNull())) {
            entity.setId((long) java_lang_Long.demarshall(obj.get("id"), a1));
          }
          if ((obj.containsKey("cod_macchina")) && (!obj.get("cod_macchina").isNull())) {
            entity.setCod_macchina(java_lang_String.demarshall(obj.get("cod_macchina"), a1));
          }
          if ((obj.containsKey("cod_art_gest")) && (!obj.get("cod_art_gest").isNull())) {
            entity.setCod_art_gest(java_lang_String.demarshall(obj.get("cod_art_gest"), a1));
          }
          if ((obj.containsKey("des_macchina")) && (!obj.get("des_macchina").isNull())) {
            entity.setDes_macchina(java_lang_String.demarshall(obj.get("des_macchina"), a1));
          }
          if ((obj.containsKey("gruppo")) && (!obj.get("gruppo").isNull())) {
            entity.setGruppo(com_cesaco_myprinterp_client_shared_Gruppo.demarshall(obj.get("gruppo"), a1));
          }
          return entity;
        } catch (Throwable t) {
          t.printStackTrace();
          throw new RuntimeException("error demarshalling entity: com.cesaco.myprinterp.client.shared.Macchina", t);
        }
      }
      public String marshall(Macchina a0, MarshallingSession a1) {
        if (a0 == null) {
          return "null";
        }
        if (a1.hasObjectHash(a0)) {
          String objId = a1.getObjectHash(a0);
          return new StringBuilder(128).append("{\"^EncodedType\":\"com.cesaco.myprinterp.client.shared.Macchina\"").append(",").append("\"^ObjectID\":\"").append(objId).append("\"}").toString();
        }
        String objId = a1.getObjectHash(a0);
        a1.recordObjectHash(objId, objId);
        return new StringBuilder(1280).append("{\"^EncodedType\":\"com.cesaco.myprinterp.client.shared.Macchina\",\"^ObjectID\":\"").append(objId).append("\"").append(",").append("\"id\" : ").append(java_lang_Long.marshall(a0.getId(), a1)).append(",").append("\"cod_macchina\" : ").append(java_lang_String.marshall(a0.getCod_macchina(), a1)).append(",").append("\"cod_art_gest\" : ").append(java_lang_String.marshall(a0.getCod_art_gest(), a1)).append(",").append("\"des_macchina\" : ").append(java_lang_String.marshall(a0.getDes_macchina(), a1)).append(",").append("\"gruppo\" : ").append(com_cesaco_myprinterp_client_shared_Gruppo.marshall(a0.getGruppo(), a1)).append("}").toString();
      }
    };
    marshallers.put("com.cesaco.myprinterp.client.shared.Macchina", com_cesaco_myprinterp_client_shared_Macchina);
    ...
    com_cesaco_myprinterp_client_shared_Gruppo = new Marshaller<Gruppo>() {
      public Class getTypeHandled() {
        return Gruppo.class;
      }
      public Gruppo demarshall(EJValue a0, MarshallingSession a1) {
        try {
          if (a0.isNull()) {
            return null;
          }
          ...
          String objId = obj.get("^ObjectID").isString().stringValue();
          if (a1.hasObjectHash(objId)) {
            return a1.getObject(Gruppo.class, objId);
          }
          Gruppo entity = new Gruppo();
          a1.recordObjectHash(objId, entity);
          if ((obj.containsKey("id")) && (!obj.get("id").isNull())) {
            entity.setId((long) java_lang_Long.demarshall(obj.get("id"), a1));
          }
          if ((obj.containsKey("macchine")) && (!obj.get("macchine").isNull())) {
            entity.setMacchine(java_util_List.demarshall(obj.get("macchine"), a1));
          }
          if ((obj.containsKey("cod_gruppo")) && (!obj.get("cod_gruppo").isNull())) {
            entity.setCod_gruppo(java_lang_String.demarshall(obj.get("cod_gruppo"), a1));
          }
          if ((obj.containsKey("des_gruppo")) && (!obj.get("des_gruppo").isNull())) {
            entity.setDes_gruppo(java_lang_String.demarshall(obj.get("des_gruppo"), a1));
          }
          return entity;
        } catch (Throwable t) {
          t.printStackTrace();
          throw new RuntimeException("error demarshalling entity: com.cesaco.myprinterp.client.shared.Gruppo", t);
        }
      }
      public String marshall(Gruppo a0, MarshallingSession a1) {
        if (a0 == null) {
          return "null";
        }
        if (a1.hasObjectHash(a0)) {
          String objId = a1.getObjectHash(a0);
          return new StringBuilder(128).append("{\"^EncodedType\":\"com.cesaco.myprinterp.client.shared.Gruppo\"").append(",").append("\"^ObjectID\":\"").append(objId).append("\"}").toString();
        }
        String objId = a1.getObjectHash(a0);
        a1.recordObjectHash(objId, objId);
        return new StringBuilder(640).append("{\"^EncodedType\":\"com.cesaco.myprinterp.client.shared.Gruppo\",\"^ObjectID\":\"").append(objId).append("\"").append(",").append("\"id\" : ").append(java_lang_Long.marshall(a0.getId(), a1)).append(",").append("\"macchine\" : ").append(java_util_List.marshall(a0.getMacchine(), a1)).append(",").append("\"cod_gruppo\" : ").append(java_lang_String.marshall(a0.getCod_gruppo(), a1)).append(",").append("\"des_gruppo\" : ").append(java_lang_String.marshall(a0.getDes_gruppo(), a1)).append("}").toString();
      }
    };
    marshallers.put("com.cesaco.myprinterp.client.shared.Gruppo", com_cesaco_myprinterp_client_shared_Gruppo);
